...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/did-vc/get-all-certificate-token-ids": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "All certificate token IDs retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/did-vc/get-all-identity-token-ids": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "All identity token IDs retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/did-vc/get-certificate-token-count": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Certificate token count retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/did-vc/get-certificate-token-ids": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Certificate token IDs retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                    ...
                    "400": {
                        "description": "Invalid request - missing parameters or invalid format",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/did-vc/get-credentials-with-metadata": {
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "example": "0",
                        "description": "Options flag (0 for identity, 1 for certificate)",
                        "name": "options",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error - credentials retrieval failed",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/did-vc/get-did-root-storage": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "DID root storage address retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                    ...
                    "500": {
                        "description": "Internal server error - address retrieval failed",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/did-vc/get-identity-token-count": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Identity token count retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/did-vc/get-identity-token-ids": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Identity token IDs retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/did-vc/get-metadata": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "0x1",
                        "description": "Token ID (hex-encoded big integer with 0x prefix)",
                        "name": "token_id",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error - metadata retrieval failed",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/did-vc/get-to-be-claimed-tokens-by-did": {
            "get": {
        ...
        "/did-vc/get-unclaimed-token-id": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Unclaimed token DID retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/did-vc/is-approved-for-all": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb",
                        "description": "Owner's Ethereum address (with 0x prefix)",
                        "name": "owner",
                        "in": "query",
                        "required": true
                    },
                    {
                        ...
                        "description": "Operator's Ethereum address (with 0x prefix)",
                        "name": "operator",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error - approval check failed",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/did-vc/is-credential-valid": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error - validity check failed",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/did-vc/total-tokens-to-be-claimed-by-did": {
            "get": {
